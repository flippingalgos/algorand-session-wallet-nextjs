...
var InsecureWallet = /** @class */ (function () {
    ...
    InsecureWallet.prototype.connect = function (mnemonic) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                sk = algosdk.mnemonicToSecretKey(mnemonic);
    ...
    InsecureWallet.displayName = function () {
        return "Insecure Wallet";
    };
    InsecureWallet.prototype.displayName = function () {
    ...
    InsecureWallet.prototype.disconnect = function () {
        this.accounts = [];
        this.pkToSk = {};
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (txidx in txns) {
                            if (!txns[txidx])
                                continue;
                            addr = algosdk.encodeAddress(txns[txidx].from.publicKey);
                            if (addr === defaultAddr) {
                                signed.push({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        addr = _a.sent();
                        return [2 /*return*/, algosdk.signTransaction(new Transaction(txn), this.pkToSk[addr].sk)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        addr = _a.sent();
                        return [2 /*return*/, algosdk.signBytes(b, this.pkToSk[addr].sk)];
                }
            });
        });
    };
